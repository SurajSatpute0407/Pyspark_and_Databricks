...
create table c1.addres_type(
	
	type char(1) primary key check(len(type)=1 and type in ('b','o','h')),
...
create table c1.state(
state_id int primary key,
state_name varchar(40),
country_code char(2)
)

INSERT INTO c1.addres_type VALUES('H','Home Address')

--Alter tables to link all tables based on suitable columns and foreign keys.

alter table c1.customers
add constraint cn foreign key (address_type) references c1.addres_type(type) 


--Change the column name from customer table customer name as c_name
EXEC sp_rename 'c1.customers.c_name', 'Cliet_name', 'COLUMN';

--Insert the suitable records into the respective tables
INSERT INTO c1.customers VALUES('Satyam','102938475612',9988776655,'2001-07-01','PUNE','H','MH')


INSERT INTO c1.state VALUES(1,'Maharashtra','MH')

insert into c1.addres_type values('o','office address')

--Change the data type of  country_code to varchar(3)
alter table c1.state
